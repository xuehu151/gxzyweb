...
//        console.log (sessionStorage.editThisOrderData3d)
    ...
    /*//兑换 排列 3 网期开奖详情
    .controller('Exchangehistory3DCtrl', function ($scope, $http, $interval, $ionicPopup, $ionicLoading) {
        $ionicLoading.show();
...
//            console.log (changeToArray1)
   ...
   /* //兑换  大乐透不追加详情
    .controller('bettingDetailCtrl', function ($scope, $ionicPopup, $timeout, $state, $http, $stateParams, $ionicLoading, $rootScope) {
