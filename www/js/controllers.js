    ...
    $scope.failThenExchange = function() {
      ...
      if ($scope.orderDetail.investCode[0].length == 5 && !$scope.orderDetail.investCode[1]) {
        var wrap5d = {
          W_Bit: [{
            "check": true,
            "num": $scope.orderDetail.investCode[0][0]
          }],
          Q_Bit: [{
            "check": true,
            "num": $scope.orderDetail.investCode[0][1]
          }],
          B_Bit: [{
            "check": true,
            "num": $scope.orderDetail.investCode[0][2]
          }],
          S_Bit: [{
            "check": true,
            "num": $scope.orderDetail.investCode[0][3]
          }],
          G_Bit: [{
            "check": true,
            "num": $scope.orderDetail.investCode[0][4]
          }]
        }
        console.log(wrap5d)
        ...
        var wrapBigLotto = {
          ...
          blue: [{
            "check": true,
            "num": $scope.orderDetail.investCode[1][0]
          }, {
            "check": true,
            "num": $scope.orderDetail.investCode[1][1]
          }, ]
        }
