...
angular.module('starter.controllers', []).controller('ExchangeCtrl', function($scope) {})
    ...
    //                console.log($rootScope.jsonWrapBit3D);
        ...
        //兑换 排列 5 往期开奖详情
        .controller ('Exchangehistory5DCtrl', function ($scope, $http) {
            var localUserInfo = window.localStorage.getItem ("userInitInfo");
            try {
                userInfo = JSON.parse (localUserInfo);
            } catch (error) {
        ...
        //兑换 排列 5 详情
        .controller ('Exchange-5DetailsCtrl', function ($scope, $state, $http) {
    ...
    //            console.info (changeToStr3D);
        ...
        //兑换  大乐透不追加
        .controller ('BigLotto-2Ctrl', function ($scope, $state, $ionicPopover, $interval, $ionicPopup) {
            //设置红球和篮球号码
            $scope.numDataRed = [];
            $scope.numDataBlue = [];
    ...
    //                        $scope.filterDataRed.push($scope.numDataRed[i]);
        ...
        //兑换  大乐透不追加详情
        .controller ('bettingDetailCtrl', function ($scope, $ionicPopup, $timeout, $state, $http) {
    ...
    //             console.log(sessionStorage.jsonWrap);
            ...
            $scope.showOrderAlertCms = function () {
                ...
                var data = {
                    ...
                    "PayType": "0",
                    "AddFlag": "0",
                    "data": [{"investCode": "01,03,05,07,09@06,08", "multiple": "1"}]
                };
                $http ({
                    method: "POST",
