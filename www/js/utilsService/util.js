...
angular.module ('starter.util', [])
    .factory ('$util', function ($http, $q, $ionicLoading) {
        ...
        var httpURL = {
            ...
            footballBgUrl : ipUrl + '/service/lottery/activityDiscount', //背景图片
            getFootballPlanUrl : ipUrl + '/service/ball/getPlan',       //足彩对阵信息
            footBallAddUrl : ipUrl + '/service/lottery/footBallAdd',
            getUserUrl : ipUrl + '/service/customer/getUser'
        };
        return {
            /* 返回httpURL  */
            getHttpURL: function () {
